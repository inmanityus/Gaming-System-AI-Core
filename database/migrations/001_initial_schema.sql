...
CREATE INDEX idx_story_branches_from_node_id ON story_branches(from_node_id);
CREATE INDEX idx_story_branches_to_node_id ON story_branches(to_node_id);
CREATE INDEX idx_story_branches_is_active ON story_branches(is_active);
CREATE INDEX idx_story_branches_conditions ON story_branches USING GIN(conditions);
