...
public class TurboLinkGrpc : ModuleRules
{
	...
	public TurboLinkGrpc(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		// Suppress gRPC header warnings and fix abseil compatibility
		bEnableExceptions = true;
		PublicDefinitions.Add("GPR_WINDOWS");
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
			...
			// Fix template visibility issues
			PublicDefinitions.Add("_ENABLE_EXTENDED_ALIGNED_STORAGE");
		}
