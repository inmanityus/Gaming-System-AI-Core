#!/bin/bash
# Initialize Aurora PostgreSQL database from bastion host or EC2 instance
...
# Now run the initialization SQL
...
SELECT COUNT(*) AS test_records FROM audio_analytics.audio_metrics WHERE user_id = 'test_user_perf';
EOF
