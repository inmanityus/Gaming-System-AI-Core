# Code Audit Trail: services/model_management/self_hosted_scanner.py
**File**: services/model_management/self_hosted_scanner.py  
...
**Path**: services/model_management/self_hosted_scanner.py  
**Size**: 11998 bytes  
**Lines**: 342  
