# Code Audit Trail: services/quest_system/objective_manager.py
**File**: services/quest_system/objective_manager.py  
...
**Path**: services/quest_system/objective_manager.py  
**Size**: 5735 bytes  
**Lines**: 171  
