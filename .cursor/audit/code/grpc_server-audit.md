# Code Audit Trail: services/language_system/grpc/grpc_server.py
**File**: services/language_system/grpc/grpc_server.py  
...
**Path**: services/language_system/grpc/grpc_server.py  
**Size**: 13614 bytes  
**Lines**: 368  
