# Code Audit Trail: services/srl_rlvr_training/dynamic/example_generator.py
**File**: services/srl_rlvr_training/dynamic/example_generator.py  
...
**Path**: services/srl_rlvr_training/dynamic/example_generator.py  
**Size**: 4180 bytes  
**Lines**: 127  
