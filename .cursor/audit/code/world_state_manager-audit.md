# Code Audit Trail: services/world_state/world_state_manager.py
**File**: services/world_state/world_state_manager.py  
...
**Path**: services/world_state/world_state_manager.py  
**Size**: 12980 bytes  
**Lines**: 306  
