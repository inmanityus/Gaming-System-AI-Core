# Code Audit Trail: services/srl_rlvr_training/recovery/checkpoint_manager.py
**File**: services/srl_rlvr_training/recovery/checkpoint_manager.py  
...
**Path**: services/srl_rlvr_training/recovery/checkpoint_manager.py  
**Size**: 7895 bytes  
**Lines**: 238  
